...
import LearnerHomePage from './components/layout/LearnerHomePage'
...
function App() {
  ...
  <ProtectedRoute>
    <LearnerHomePage toggleDarkMode={toggleDarkMode} darkMode={darkMode} />
  </ProtectedRoute>
} />
            {/* Protected routes */}
            <Route path="/" element={
              ...
              <Route path="learner/dashboard" element={<Dashboard darkMode={darkMode} />} />
              <Route index element={<Home darkMode={darkMode} />} />
              <Route path='about' element={<About darkMode={darkMode} />} />
              <Route path="learner/courses" element={<Courses darkMode={darkMode} />} />
              <Route path="/explore-courses/:courseId" element={<ExploreCourses darkMode={darkMode} />} />
